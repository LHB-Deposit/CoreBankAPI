using System;
using AMLOAPIService.Data;
using AMLOAPIService.Helpers;
using DataAccess;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "LHB AML Actimize Service API",
                    Version = "v1",
                    Description = "Anti-Money Launde​​ring Service API.",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                configs.SwaggerEndpoint("/swagger/v1/swagger.json", "LHB AML Actimize Service API V1");
            });
