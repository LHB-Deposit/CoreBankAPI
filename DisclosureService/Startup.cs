using System;
using DataAccess;
using DisclosureAPIService.Data;
using DisclosureAPIService.Helpers;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "LHB Disclosure Service API",
                    Version = "v1",
                    Description = "Disclosure Service.",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                configs.SwaggerEndpoint("/swagger/v1/swagger.json","LHB Disclosure Service API V1");
            });
